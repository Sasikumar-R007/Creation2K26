      ...
      <section id="events" className="py-24 relative">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20 relative group">
            ...
            {/* Prize Pool Badge - Golden Biscuit */}
            <div className="absolute -top-4 -right-8 md:-right-12 lg:-right-20 transform rotate-[8deg] hover:rotate-[5deg] transition-transform duration-300 z-10">
