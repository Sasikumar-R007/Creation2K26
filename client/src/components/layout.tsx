      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/5 h-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-xl tracking-tighter">SYMPOSIUM_24</span>
          </Link>
      ...
      <footer className="bg-card border-t border-white/5 py-12 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <h3 className="font-display font-bold text-lg mb-2">SYMPOSIUM_24</h3>
            <p className="text-muted-foreground text-sm">The ultimate tech convergence.</p>
          </div>
